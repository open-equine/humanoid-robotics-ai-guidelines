...
<h1 align="center">Humanoid, Robotics & AI Guidelines</h1>
<h3 align="center">Open Equine Intelligence Systems</h3>
...
│
├── definitions/
│   └── OE-GL-000_Definitions-Framework.md
│
├── guidelines/
...
| Reference | Title | Status |
|---|---|---|
| OE-GL-000 | Definitions Framework — Intelligent and Biomimetic Systems in Equine Stable Environments | ✅ Published |
...
1. Read `rationale/OE-PRE-001` for documented risk context
2. Read `definitions/OE-GL-000` for classification framework
...
1. Read `definitions/OE-GL-000` to classify the system under development
...
1. Read `rationale/OE-PRE-001` for equine-specific risk documentation
2. Read `definitions/OE-GL-000` for technology category definitions
...
1. Read `rationale/OE-PRE-002` for deployment context
2. Read `definitions/OE-GL-000` to identify the technology category relevant to your facility
...
1. Read `rationale/OE-PRE-001` for the documented regulatory vacuum this framework addresses
2. Read `definitions/OE-GL-000` for the classification and definitional structure
...
Contact [openequine.org](https://openequine.org) to contribute.
...
You are free to use, copy, modify, merge, publish, distribute, sublicense, and adapt this work for any purpose, subject to attribution to **Open Equine Intelligence Systems**.
